...
const WEB_BASE_URL = 'http://127.0.0.1:8001';
const NATIVE_BASE_URL = process.env.EXPO_PUBLIC_API_URL || WEB_BASE_URL;
const BASE_URL = Platform.OS === 'web' ? WEB_BASE_URL : NATIVE_BASE_URL;
